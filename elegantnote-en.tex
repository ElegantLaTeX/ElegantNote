\documentclass[en,geye,green,screen,14pt]{elegantnote}
...
\maketitle
% logo
\centerline{\includegraphics[width=0.2\textwidth]{logo.pdf}}
...
\begin{note}
You can use \hologo{pdfLaTeX} or \hologo{XeLaTeX} to process your notes. You can input Chinese Characters in \lstinline{lang=cn}\footnote{\lstinline{ctex} package is called.} mode only. 
\end{note}
